...
namespace SuitsUIConsole
{
    ...
    namespace Spacesuit
    {
        ...
        using SuitsUIConsole.Spacesuit.Vitals; // import Vitals for Spacesuit from same namespace, different file
        ...
        public class Suit
        {
            ...
            public Suit()
            {
                // TODO: initialize each class of vitals to measure and add to vitals list 
